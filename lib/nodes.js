(function() {
  ...
  exports.Class = Class = (function() {
    ...
    Class.prototype.addProperties = function(node, name, o) {
      var assign, base, definer, definerName, exprs, func, props;
        ...
        while (assign = props.shift()) {
          if (assign instanceof Assign) {
            ...
            if (base.value === 'constructor') {
              ...
              definerName = new Literal(this.control[assign.control.value]);
  ...
  exports.Assign = Assign = (function() {
    ...
    function Assign(variable, value, context, options) {
      ...
      this.control = options != null ? options.control : void 0;
    }
  ...
  exports.While = While = (function() {
    ...
    While.prototype.compileNode = function(o) {
      ...
      code = set_pre + this.tab + ("while (" + (this.condition.compile(o, LEVEL_PAREN)) + ") {" + body + "}");
      if (this.returns) {
