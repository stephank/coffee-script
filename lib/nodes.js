(function() {
  ...
  exports.ValueNode = (function() {
    ...
    ValueNode.prototype.isThis = function() {
      return this.base.value === 'this' && this.properties.length === 1;
    };
  ...
  exports.ClassNode = (function() {
    ...
    ClassNode.prototype.children = ['variable', 'parent', 'body'];
    ...
    ClassNode.prototype.traverseChildren = function(crossScope, func) {
      if (crossScope) {
        return ClassNode.__super__.traverseChildren.call(this, crossScope, func);
      }
    };
    ClassNode.prototype.compileNode = function(o) {
      var _b, _c, _d, _e, applied, className, constScope, construct, constructor, expr, extension, func, me, name, props, pvar, returns;
      ...
      _c = this.body.expressions;
      for (_b = 0, _d = _c.length; _b < _d; _b++) {
        expr = _c[_b];
        if (expr instanceof AssignNode) {
          _e = [expr.variable, expr.value];
          pvar = _e[0];
          func = _e[1];
          if (pvar.isThis() && (pvar.properties[0].name.value === 'constructor') && func instanceof CodeNode) {
            if (func.bound) {
          ...
          if (pvar.isThis() && func instanceof CodeNode && func.bound) {
            func.bound = false;
      ...
      props = !props.empty() ? '\n' + this.tab + '(function() {\n' + props.compile(merge(o, {
        indent: this.idt(1)
      })) + ("\n" + (this.tab) + "}).call(" + (className) + ".prototype);") : '';
