  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitBraces = function() {
      ...
      condition = function(token, i) {
        ...
        tag = token[0];
        if (tag === ',' && (next !== 'IDENTIFIER' && next !== 'NUMBER' && next !== 'STRING' && next !== '@' && next !== 'GET' && next !== 'SET' && next !== 'TERMINATOR' && next !== 'OUTDENT')) {
          return true;
        }
        if (tag !== 'TERMINATOR' && tag !== 'OUTDENT') {
          return false;
        }
        idx = 2;
        if (next === 'GET' || next === 'SET') {
          idx++;
        }
        if (this.tag(i + idx - 1) === '@') {
          idx++;
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        ago = this.tag(idx = i - 2);
        if (ago === '@' || ago === 'GET' || ago === 'SET') {
          ago = this.tag(idx = i - 3);
        }
        if (!(tag === ':' && (ago === ':' || ((_ref2 = stack[stack.length - 1]) != null ? _ref2[0] : void 0) !== '{'))) {
          return 1;
        }
        stack.push(['{']);
        idx++;
